    ...
    // const sliceString = (temp_array) => {
        ...
        for (var i=0; i < temp_array.length; i++) {
            ...
            if (sCnt === eCnt) {
                ...
                // 올바른 문자열
                if (correctCheck(u)) {
                    console.log('올바른 문자열 u>> ', u);
                    console.log('올바른 문자열 v>> ', v);
                    answer += u;
                    console.log('answer 111>> ' , answer);
                    answer += solution(v);          // v에 대해 1단계 부터 다시 수행
                    console.log('answer 222>> ' , answer);
                    return answer;
                // 올바른 문자열 아닐 때
                } else {
                    console.log('올바른 문자열xx u>> ', u);
                    console.log('올바른 문자열xx v>> ', v);
                    ...
                    var data = "";
                    var aData = u.slice(1, u.length-1);
